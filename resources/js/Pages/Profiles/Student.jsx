...
export default function StudentProfile() {
    ...
    const { user, student, cgpa, guardian, address, s_id, seatAllocation, profile_image } = usePage().props;
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-blue-100 shadow-md sm:rounded-lg">
                        <div className="p-6 flex flex-col items-center"> {/* Added flex and items-center */}
                            <img
                            ...
                            />
                            <h2 className="mt-4 mb-2 text-gray-800 font-bold text-xl text-center">{student.user?.name} (ID: {student.SID})</h2>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-5">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow">
                            ...
                            {student.user.address &&
                                <>
                                    <h2 className="mb-2 text-gray-800 text-base"><span
                                        className="font-semibold">Present Address: </span>{student.user.address.present_area}, {student.user.address.present_upazilla}, {student.user.address.present_district}, {student.user.address.present_division},
                                    </h2>
                                    <h2 className="mb-2 text-gray-800 text-base"><span
                                        className="font-semibold">Permanent Address: </span>{student.user.address.permanent_area}, {student.user.address.permanent_upazilla}, {student.user.address.permanent_district}, {student.user.address.permanent_division}
                                    </h2>
                                </>
                            }
                        </div>
